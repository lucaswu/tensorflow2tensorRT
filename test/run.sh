...
protoc --python_out=${CurrentDir}/../python/tools  --proto_path=${CurrentDir}/../proto/ ${CurrentDir}/../proto/tensorrt.proto
echo "protoc success"
...
mv tensorrt.*  ${CurrentDir}/../c++/model/protobuf
cp ${CurrentDir}/../proto/tensorrt.proto ${CurrentDir}/../c++/proto